...
def kalman(Te, y_k, x_kalm_prec, p_kalm_prec):
    """
    ...
    sigma_angle = 40.  # Ecart type sur la mesure de l'angle (on peut à priori la supposer nulle dans notre cas)
    sigma_distance = 40.  # Ecart type sur la mesure de la distance (à mesurer)
